...
namespace App\MoonShine\Resources\ProductImage\Pages;
...
/**
 * @extends FormPage<ProductImageResource>
 */
class ProductImageFormPage extends FormPage
{
    /**
    ...
    protected function fields(): iterable
    {
        return [
            Box::make([
                ...
                Text::make('ALT RU', 'alt_ru'),
                Text::make('ALT BY', 'alt_by'),
            ]),
        ];
    }
