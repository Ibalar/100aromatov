...
@section('title', __('Акции') . ' - ' . config('app.name'))
@section('meta_description', __('Товары со скидкой в интернет-магазине'))
                    ...
                    <div class="canvas-sidebar sidebar-filter canvas-filter left">
                        <div class="canvas-wrapper">
                            ...
                            <div class="canvas-body">
                                <form method="GET" action="{{ route('sale.index') }}" class="filter-form">
                                        ...
                                        <div class="widget-facet">
                                            ...
                                            <div id="filter-brand" class="collapse show">
                                                <ul class="collapse-body filter-group-check">
                                                    <li class="list-item">
                                                        <a href="{{ route('sale.index', request()->except(['brand', 'page'])) }}" class="label link">
                                    ...
                                    <div class="filter-actions d-xl-none">
                                        ...
                                        <a href="{{ route('sale.index') }}" class="tf-btn btn-white w-100 mt-2">
