        ...
        <div class="container">
            @if(session('success_order_id'))
                <div class="alert alert-success mb-24">
                    #{{ session('success_order_id') }} {{ __('Заявка на бронирование успешно отправлена. Товар забронирован для Вас на 24 часа. В случае отсутствия товара на момент заказа, в течение 30 минут с Вами свяжется консультант магазина') }}
                </div>
            @endif
